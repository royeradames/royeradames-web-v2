const skilledWithSection = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'TypeScript (TS)',
      description:
        'JavaScript with types. Helps us find bugs before deployment',
    ...
    },
    {
      ...
      title: 'Node.js',
      description:
        'The grandfather of running Javascript outside of the browser',
...
export default skilledWithSection;
